...
#define STRING_CONFIG_H_AUTHOR "(Rudiyer S Alvarado)" // Who made the changes.
 ...
 * :[0:'Classic', 1:'Průša']
 */
#define LCD_INFO_SCREEN_STYLE Classic
